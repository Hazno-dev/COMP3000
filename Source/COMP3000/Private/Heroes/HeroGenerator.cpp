...
bool UHeroGenerator::GenerateHeroMesh(UPARAM(ref) USkeletalMesh& PlayerMesh, UPARAM(ref) TArray<USkeletalMesh*>& MeshesToMerge) {

	if (!IsValid(&PlayerMesh) || MeshesToMerge.Num() == 0) return false;
	
	// Create a new skeletal mesh 
	USkeletalMesh* BaseMesh = NewObject<USkeletalMesh>();
	BaseMesh->SetSkeleton(PlayerMesh.GetSkeleton());
	if (!BaseMesh) return false;

	for (int i = 0; i < MeshesToMerge.Num(); i++) {
		if (!MeshesToMerge[i]) MeshesToMerge.RemoveAt(i);
	}
	...
	FSkelMeshMergeUVTransformMapping UVMapping = FSkelMeshMergeUVTransformMapping();
	UVMapping.UVTransformsPerMesh = UVTransforms;
	...
	if (!MeshMerge.FinalizeMesh()) return false;
	

	HeroMeshes.Add(BaseMesh);
...
void UHeroGenerator::GenerateHero(FHeroDataStruct& InHero) {
		//Gendered Data
...
void UHeroGenerator::SetMaterialParameters(FHeroDataStruct InHero) {
...
void UHeroGenerator::SetMeshes(FHeroDataStruct InHero) {
...
SkeletalMeshes.Add(GTorso->GetSkeletalMeshAsset());
SkeletalMeshes.Add(GHead->GetSkeletalMeshAsset());
SkeletalMeshes.Add(GEyebrows->GetSkeletalMeshAsset());
SkeletalMeshes.Add(GFacialHair->GetSkeletalMeshAsset());
SkeletalMeshes.Add(GArmUpperL->GetSkeletalMeshAsset());
SkeletalMeshes.Add(GArmUpperR->GetSkeletalMeshAsset());
SkeletalMeshes.Add(GArmLowerL->GetSkeletalMeshAsset());
SkeletalMeshes.Add(GArmLowerR->GetSkeletalMeshAsset());
SkeletalMeshes.Add(GHandL->GetSkeletalMeshAsset());
SkeletalMeshes.Add(GHandR->GetSkeletalMeshAsset());
SkeletalMeshes.Add(GHips->GetSkeletalMeshAsset());
SkeletalMeshes.Add(GLegL->GetSkeletalMeshAsset());
SkeletalMeshes.Add(GLegR->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AHeadCoveringNoHair->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AHair->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AHeadAttachmentHair->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AHeadAttachmentHelmet->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AChestAttachment->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AHeadCoveringBaseHair->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AHeadCoveringNoFacialHair->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AShoulderAttachmentL->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AShoulderAttachmentR->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AElbowAttachmentL->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AElbowAttachmentR->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AHipAttachment->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AKneeAttachmentL->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AKneeAttachmentR->GetSkeletalMeshAsset());
SkeletalMeshes.Add(AExtra->GetSkeletalMeshAsset());
	
if(HeroGeneratorComponent->GenerateHeroMesh(GetMesh()->SkeletalMesh, SkeletalMeshes)) GetMesh()->SetSkeletalMesh(HeroGeneratorComponent->HeroMeshes[0]);
*/
